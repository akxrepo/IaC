...
resource "aws_subnet" "test-subnet-pvt-1" {
  ...
  map_public_ip_on_launch = false
    tags = {
        Name = "Web-Tier-Private-Subnet-1"
        Type = "Private"
    }
}
...
resource "aws_subnet" "test-subnet-pvt-2" {
  ...
  map_public_ip_on_launch = false
    tags = {
        Name = "Web-Tier-Private-Subnet-2"
        Type = "Private"
    }
}
